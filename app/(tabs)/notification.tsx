...
export default function HomeScreen() {
  ...
  const filteredNotifications =
    activeFilter === 'All'
      ...
      ? [...notifications, ...sampleMessages].filter((notification) => notification.type === 'message')
      : sampleGroups;
  ...
  const renderNotification = (item) => (
    <View key={item.id} style={[styles.notificationCard, { backgroundColor: theme === 'light' ? '#fff' : '#333' }]}>
